...
export class TmpoSpriteComponent implements OnInit, OnDestroy {
...
@NgModule({
  ...
  declarations: [TmpoSpriteComponent],
  exports: [TmpoSpriteComponent]
})
export class TmpoSpriteModule {}
