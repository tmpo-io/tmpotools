...
@Component({
  ...
  animations: [
    trigger('state', [
      ...
      transition('recording <=> stopped', animate('0.5s cubic-bezier(0.25, 0.1, 0.25, 1)')),
    ])
  ]
})
...
@NgModule({
  ...
  exports: [RecordButtonComponent]
})
export class RecordButtonModule { }
